...
#include "stdafx.h"
#include "spitonicbasicsynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicbasicsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicbasicsynthvoroguiwin32class"};				// the main window class name
